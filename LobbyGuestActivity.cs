...
{
    [Activity(Label = "Guest - Lobby", Theme = "@style/Theme.DesignDemo")]
    public class LobbyGuestActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_lobbyguest);
            //Toast.MakeText(this, HostIPActivity.NameFREE, ToastLength.Long).Show();
            RunOnUiThread(() => LobbyParticipant_Load());
        ...
        private void LobbyParticipant_Load()
        {
            ...
            {
                RunOnUiThread(() => Send(HostIPActivity.NameFREE));
            }
        }
